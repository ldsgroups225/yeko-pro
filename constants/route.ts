...
import { BookOpen, Calendar, Home, ListChecks, NotebookIcon, Settings, Shield, Users, UsersRound, Wallet2Icon } from 'lucide-react'
...
export const sidebarItems: ISidebarItem[] = [
  ...
  },
  {
    ...
    label: 'Conduite',
    href: '/t/conducts',
    ariaLabel: 'Gérer la conduite des élèves',
  },
  {
    icon: ListChecks,
