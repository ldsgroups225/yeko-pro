...
function usePaymentPlanRowLogic(
  ...
  const { updateInstallmentTemplate, deleteInstallmentTemplate } = useTuitionStore()
  ...
  const handleDeleteConfirm = async () => {
    setIsDeleting(true)
    try {
      await deleteInstallmentTemplate(plan.id!)
            ...
            {isEditing
              ...
              : (
                  ...
                  >
                    ...
                    <Button size="icon" variant="ghost" onClick={handleDeleteClick} disabled={isDeleting}>
...
function PaymentPlanRowContainer({
  ...
  return (
    <PaymentPlanRowView
      ...
      handleDeleteCancel={logic.handleDeleteCancel}
