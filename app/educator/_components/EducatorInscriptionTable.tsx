                        ...
                        ? (
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem onClick={() => onStatusChange(inscription.id, 'accepted')}>
                                  Approuver
                                </DropdownMenuItem>
                                {/* <DropdownMenuItem onClick={() => onStatusChange(inscription.id, 'pending')}>
                                  Mettre en attente
                                </DropdownMenuItem> */}
                                <DropdownMenuItem onClick={() => onStatusChange(inscription.id, 'refused')}>
                                  Refuser
                                </DropdownMenuItem>
                              </DropdownMenuContent>
                            </DropdownMenu>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2 pt-2">
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => onStatusChange(inscription.id, 'active')}
                      className="flex-1"
                    >
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        ...
                        <DropdownMenuItem onClick={() => onStatusChange(inscription.id, 'inactive')}>
                          Désactiver
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
