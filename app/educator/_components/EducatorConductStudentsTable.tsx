// app/educator/_components/EducatorConductStudentsTable.tsx
...
interface EducatorConductStudentsTableProps {
...
export function EducatorConductStudentsTable({
  students,
  isLoading,
  onSort,
  onAddIncident,
  sortColumn,
  sortDirection,
}: EducatorConductStudentsTableProps) {
    ...
    <TooltipProvider>
      <div className="space-y-4">
        ...
        <div className="hidden lg:block">
          <div className="rounded-xl border-0 bg-gradient-to-br from-background/95 via-card/90 to-accent/20 backdrop-blur-sm shadow-sm overflow-hidden">
            <Table>
              <TableHeader>
                    ...
                    <TableRow key={student.id} className="hover:bg-secondary/40 border-b border-slate-100 group transition-colors">
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          <Avatar className="h-11 w-11 ring-2 ring-secondary shadow-sm">
                      ...
                      <TableCell>
                        <Badge variant="outline" className="font-medium text-xs px-3 py-1.5 bg-secondary border-secondary-foreground text-secondary-foreground">
                          {student.className}
                        </Badge>
                      </TableCell>
